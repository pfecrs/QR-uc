...
<div class="page-content-inner">
    ...
    <div class="form-layout">
        ...
        <form action="{{route('storeEtudiant')}}" method="post">
            @csrf
                    <div class="columns is-multiline">
                        ...
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icon">
                                    <input type="text" class="input" name="departement" placeholder="département">
                                    <div class="form-icon">
                        ...
                        <div class="column is-6">
                            <div class="field">
                                <label>niveau</label>
                                <div class="control has-icon">
                                    <input type="number" class="input" name="niveau" placeholder="niveau">
                                    <div class="form-icon">
