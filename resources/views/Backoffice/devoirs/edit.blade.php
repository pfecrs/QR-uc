...
<div class="page-content-inner">
    ...
    <div class="form-layout">
        ...
        <form action="{{route('updateDevoir')}}" method="post">
            @csrf
                    ...
                    <div class="columns is-multiline">
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icon">
                                    <input type="text" class="input" value="{{$devoir->matiere}}" name="matiere" placeholder="Matiere">
                                    <div class="form-icon">
                        ...
                        <div class="column is-6">
                            <div class="field">
                                ...
                                <div class="control has-icon">
                                    <input type="text" class="input" name="type" value="{{$devoir->type}}" placeholder="Type">
                                    <div class="form-icon">
                                        <i data-feather="hash"></i>
                                    </div>
                                </div>
                        ...
                        <div class="column is-12">
                            <div class="field">
                                ...
                                <div class="control has-icon">
                                    <input type="number" class="input" name="num_cin" value="{{$devoir->num_cin_etudiant}}" placeholder="Num CIN Etudiant">
                                    <div class="form-icon">
                                        <i data-feather="hash"></i>
                                    </div>
                                </div>
